...
class Product(models.Model):
    ...
    image4 = models.ImageField(upload_to='products/%Y/%m/%d', blank=True)# this is a stupid workaround
    image5 = models.ImageField(upload_to='products/%Y/%m/%d', blank=True)
    description = models.TextField(blank=True)
    product_tag = models.TextField(blank=True)
    color = models.CharField(max_length=40, blank=False)
    SKU = models.TextField(blank=True, max_length=10)
